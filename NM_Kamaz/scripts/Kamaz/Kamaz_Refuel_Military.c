class Kamaz_Refuel_Military extends CarScript
{
	void Kamaz_Refuel_Military()
	{
	...
	override void OnDebugSpawn()
	{
		...
		if ( Class.CastTo(entity, this) )
		{
			...
			if (this.GetType() == "Kamaz_Refuel_Military_2")
			{
			...
			if (this.GetType() == "Kamaz_Refuel_Civilian")
			{
				entity.GetInventory().CreateInInventory( "Kamaz_doors_Driver_Civilian_Fuel" );
				entity.GetInventory().CreateInInventory( "Kamaz_Doors_coDriver_Civilian_Fuel" );
			}
			
			if (this.GetType() == "Kamaz_Refuel_Civilian_2")
			{
				entity.GetInventory().CreateInInventory( "Kamaz_doors_Driver_Civilian_2_Fuel" );
				entity.GetInventory().CreateInInventory( "Kamaz_Doors_coDriver_Civilian_2_Fuel" );
			}
			
			if (this.GetType() == "Kamaz_Refuel_Civilian_3")
			{
			...
			if (this.GetType() == "Kamaz_Refuel_Civilian_4")
			{
