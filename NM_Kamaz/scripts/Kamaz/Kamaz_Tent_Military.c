class Kamaz_Tent_Military extends CarScript
{
	void Kamaz_Tent_Military()
	{
	...
	override void OnDebugSpawn()
	{
		...
		{
			if (this.GetType() == "Kamaz_Tent_Civilian")
			{
				entity.GetInventory().CreateInInventory( "Kamaz_doors_Driver_Civilian" );
				entity.GetInventory().CreateInInventory( "Kamaz_Doors_coDriver_Civilian" );
				entity.GetInventory().CreateInInventory( "Kamaz_doors_trunk_Civilian" );
			}
			
			if (this.GetType() == "Kamaz_Tent_Civilian_2")
			{
				entity.GetInventory().CreateInInventory( "Kamaz_doors_Driver_Civilian_2" );
				entity.GetInventory().CreateInInventory( "Kamaz_Doors_coDriver_Civilian_2" );
				entity.GetInventory().CreateInInventory( "Kamaz_doors_trunk_Civilian" );
			}
			
			if (this.GetType() == "Kamaz_Tent_Civilian_3")
			{
				entity.GetInventory().CreateInInventory( "Kamaz_doors_Driver_Civilian_3" );
				entity.GetInventory().CreateInInventory( "Kamaz_Doors_coDriver_Civilian_3" );
				entity.GetInventory().CreateInInventory( "Kamaz_doors_trunk_Civilian" );
			}
			
			if (this.GetType() == "Kamaz_Tent_Civilian_4")
			{
				entity.GetInventory().CreateInInventory( "Kamaz_doors_Driver_Civilian_4" );
				entity.GetInventory().CreateInInventory( "Kamaz_Doors_coDriver_Civilian_4" );
				entity.GetInventory().CreateInInventory( "Kamaz_doors_trunk_Civilian" );
			}
			
			if (this.GetType() == "Kamaz_Tent_Civilian_5")
			{
				entity.GetInventory().CreateInInventory( "Kamaz_doors_Driver_Civilian_5" );
				entity.GetInventory().CreateInInventory( "Kamaz_Doors_coDriver_Civilian_5" );
				entity.GetInventory().CreateInInventory( "Kamaz_doors_trunk_Civilian" );
			}
			
			if (this.GetType() == "Kamaz_Tent_Civilian_6")
			{
				entity.GetInventory().CreateInInventory( "Kamaz_doors_Driver_Civilian_6" );
				entity.GetInventory().CreateInInventory( "Kamaz_Doors_coDriver_Civilian_6" );
				entity.GetInventory().CreateInInventory( "Kamaz_doors_trunk_Civilian" );
			}
			
			if (this.GetType() == "Kamaz_Tent_Civilian_6B")
			{
				entity.GetInventory().CreateInInventory( "Kamaz_doors_Driver_Civilian_6" );
				entity.GetInventory().CreateInInventory( "Kamaz_Doors_coDriver_Civilian_6" );
				entity.GetInventory().CreateInInventory( "Kamaz_doors_trunk_Civilian" );
			...
			if (this.GetType() == "Kamaz_Tent_Civilian_7")
			{
				entity.GetInventory().CreateInInventory( "Kamaz_doors_Driver_Civilian_7" );
				entity.GetInventory().CreateInInventory( "Kamaz_Doors_coDriver_Civilian_7" );
				entity.GetInventory().CreateInInventory( "Kamaz_doors_trunk_Civilian" );
			}
