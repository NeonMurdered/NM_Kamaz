class Kamaz_Military extends CarScript
{
	void Kamaz_Military()
	{
	...
	override void OnDebugSpawn()
	{
		...
		{
			if (this.GetType() == "Kamaz_Civilian")
			{
			...
			if (this.GetType() == "Kamaz_Civilian_2")
			{
			...
			if (this.GetType() == "Kamaz_Civilian_3")
			{
			...
			if (this.GetType() == "Kamaz_Civilian_4")
			{
			...
			if (this.GetType() == "Kamaz_Civilian_5")
			{
			...
			if (this.GetType() == "Kamaz_Civilian_6")
			{
			...
			if (this.GetType() == "Kamaz_Civilian_6B")
			{
				entity.GetInventory().CreateInInventory( "Kamaz_doors_Driver_Civilian_6" );
				entity.GetInventory().CreateInInventory( "Kamaz_Doors_coDriver_Civilian_6" );
				entity.GetInventory().CreateInInventory( "Kamaz_doors_trunk_Civilian" );
			...
			if (this.GetType() == "Kamaz_Civilian_7")
			{
